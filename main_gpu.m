...
% 2020. 07. 12 
% Follow up code for
% G. Kuo et al., "High Resolution Etendue Expansion for Holographic Displays", 
% SIGGRAPH, ACM TOG, 2020
% (No constraint, Frequency constraint, Spatial constraint for foveated display) 
% The custom MATLAB library for L-BFGS algorithm written by Dirk-Jan Kroon is used. 
% 
% by Dongheon Yoo
